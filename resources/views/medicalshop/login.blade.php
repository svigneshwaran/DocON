...
@section('title', 'Medical Shop Login - DocON')
@section('content')
    ...
    <div class="col-md-12" style="padding-top: 50px;"></div>
        ...
        <script type="text/javascript">
            sweetAlert("Sorry...", "Your username is wrong!", "error");
        </script>
        @endif
        @if(session('status') == 2)
        <script type="text/javascript">
    ...
    <div class="container">
        ...
        <div class="col-sm-6">
            <div class="well bs-component">
                <form class="form-horizontal" action="{{ URL::asset('medical/login') }}" method="post">
                {{ csrf_field() }}
                    <fieldset>
                        <legend>Medical Shop Login</legend>
                        ...
                        <div class="col-md-12" style="padding-top: 10px;">
                            <center>Not a member. Please <a href="{{ URL::asset('medicalshop/signup') }}">Register</a></center>
                        </div>
                        <div class="form-group">
                            <div class="col-md-10">
