...
@section('title', 'Doctor Login - DocON')
@section('content')
    ...
    <div class="container">
        ...
        <div class="col-sm-6">
            <div class="well bs-component">
                <form class="form-horizontal" action="{{ URL::asset('doctor/login') }}" method="post">
                {{ csrf_field() }}
                    <fieldset>
                        ...
                        <div class="col-md-12" style="padding-top: 10px;">
                            <center>Not a member. Please <a href="{{ URL::asset('doctor/signup') }}">Register</a></center>
                        </div>
                        <div class="form-group">
                            <div class="col-md-10">
